...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setSubmitted(true);
    // Di sini biasanya ada logika pengiriman data ke API
    setFormData({ name: '', email: '', message: '' });
  };

  return (
    <section id="contact" className="py-24 bg-darkBg px-4 md:px-6 overflow-hidden relative">
      <div className="absolute top-0 right-[20%] w-[40%] h-[40%] bg-blue-900/10 rounded-full blur-[150px] pointer-events-none" />
            ...
            <div className="glass-card p-6 flex flex-col gap-6">
              <div className="flex items-center gap-5 group">
                ...
                <div>
                  ...
                  <a href="mailto:fadhilahmad1199@gmail.com" className="text-white hover:text-gray-300 transition-colors">
                    fadhilahmad1199@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5 group">
                ...
                <div>
                  ...
                  <a href="tel:+6285859104796" className="text-white hover:text-gray-300 transition-colors">
                    +62 858 5910 4796
                  </a>
                </div>
              </div>
